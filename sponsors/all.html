...
<head>
  ...
  <title>Team 7052 | Sponsors</title>
</head>
<body>
  <div class="page">
    <div class="page-main-container">
      ...
      <div class="navbar">
        ...
        <div class="navbar-element navbar-dropdown-section"><a href="all.html">Sponsors</a></div>
      ...
      <div class="page-title-section">
        <div class="page-main-title">Sponsors</div>
      </div>
      <!-- Renamed to sub-navbar since this will be a global element (used in every page) -->
      <div class="sub-navbar">
        <div class="sub-navbar-element"><a href="#">Platinum</a></div>
        <div class="sub-navbar-element"><a href="#">Gold</a></div>
        <div class="sub-navbar-element"><a href="#">Silver</a></div>
        <div class="sub-navbar-element"><a href="#">Gold</a></div>
      </div>
    </div>
