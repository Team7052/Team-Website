...
<head>
  ...
  <title>Team 7052 | Resources</title>
</head>
<body>
  <div class="page">
    <div class="page-main-container">
      ...
      <div class="navbar">
        ...
        <div class="navbar-element navbar-dropdown-section"><a href="blog.html">Resources</a></div>
      </div>
      ...
      <div class="page-title-section">
        <div class="page-main-title">Resources</div>
        <div class="page-main-subtitle">blog</div>
      </div>
      <!-- Renamed to sub-navbar since this will be a global element (used in every page) -->
      <div class="sub-navbar">
        <div class="sub-navbar-element sub-navbar-element-selected"><a href="">Blog</div>
      </div>
    </div>
