  ...
  <div class="page">
    <div class="page-main-container">
      ...
      <div class="navbar">
        ...
        <div class="navbar-element navbar-dropdown-section"><a href="gallery.html">Media</a></div>
      ...
      <div class="page-title-section">
        <div class="page-main-title">Media</div>
        <p class="page-main-subtitle">social</p>
      </div>
      <!-- Renamed to sub-navbar since this will be a global element (used in every page) -->
      <div class="sub-navbar">
        <div class="sub-navbar-element"><a href="gallery.html">Gallery</a></div>
        <div class="sub-navbar-element"><a href="news.html">News</a></div>
        <div class="sub-navbar-element sub-navbar-element-selected"><a href="social.html">Social</a></div>
      </div>
    </div>
